...
const HEADLINES = [
  ...
  { pre: 'Stunning ',     hi: 'Landing Page Templates',       post: '\nthat convert visitors into customers.' },
  { pre: 'Production ',   hi: 'SaaS Starter Kits',            post: '\nship your product in days, not months.'},
  { pre: 'Polished ',     hi: 'Business & Portfolio Themes',  post: '\nbuilt to impress from first glance.'   },
  { pre: 'One Click ',    hi: 'Design-Ready Templates',       post: '\nfor teams who value their time.'       },
]
...
function Page() {
  ...
  return (
    <div className='md:container lg:w-8xl w-full min-h-auto border-r border-l border-neutral-300 dark:border-neutral-800 mx-auto'>
      {/* Heading */}
      <div className='relative h-auto pt-18 mx-auto'>
      ...
      <p className="lg:px-0 mx-auto py-4 font-sans font-medium text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed max-w-sm lg:max-w-none">
        ...
        <div className="w-full mx-auto flex flex-wrap justify-center items-center pb-5 gap-3 pt-4">
            <Link href="https://lokalhost-io-i2di.vercel.app/templates" target='_blank'
              className={cn(
                "group relative flex justify-between items-center gap-2 px-3 w-[260px] h-[46px] rounded-lg text-sm font-sans font-semibold overflow-hidden",
                "border border-orange-300/60",
                "bg-gradient-to-r from-[#FFF5F0] to-[#FFEADC]",
                "text-neutral-700",
            ...
            >
              <span className={cn(
                ...
                "group-hover:translate-x-[212px] group-hover:rotate-[360deg]"
              )}>
              ...
              <span className={cn(
                ...
                Lokalhost.io Templates
              </span>
                        </Link>

            {/* Button 2 — text slides right, icon rolls left */}
            <Link href="https://lokalhost-io-i2di.vercel.app/pricing" target='_blank'
              className={cn(
                "group relative flex justify-between justify-center items-center gap-2 px-3 w-[180px] h-[46px] rounded-lg text-sm font-sans font-semibold overflow-hidden",
          ...
          <StripedPattern/>
              ...
              {/* Components list  */}
                ...
                <div className='pt-10 pb-4 px-5'>
                    <h1 className='font-sans font-bold text-xl lg:text-5xl mx-auto text-left text-neutral-700 dark:text-neutral-300'>Premium Templates + Landings</h1>
                    <p className='font-sans font-medium text-sm mx-auto text-left text-neutral-600 dark:text-neutral-400 pl-2 pt-2'>Explore the best in class, shadcn compatible components with microinteractions and animations.</p>
                </div>
        ...
        <div className=' w-full h-full pt-8 pb-8 lg:pt-6 mx-auto'>
...
function CustomWorkCTA() {
  return (
    <div className="md:container lg:w-8xl w-full mx-auto py-20 px-4">
      <div
        className={cn(
