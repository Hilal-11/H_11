  ...
  return (
    <div className='w-full h-[900px] overflow-hidden pt-10 relative'>
        <div className='border w-full py-2 px-5'>
            <h1 className='text-3xl font-bold font-mono text-left'>Figma UI Designs Kits</h1>
        </div>
