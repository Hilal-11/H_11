...
import { footerConfig } from "@/config/footerConfigData"
    ...
    />
      <div className='relative container mx-auto !important border-dashed z-30 !important bg-neutral-100 dark:bg-neutral-950
       h-auto border-l border-r border-neutral-400 dark:border-neutral-700 py-20 px-10'>
        ...
        <div className='pt-4 lg:pt-10 grid lg:grid-cols-4 md:grid-cols-4 gap-4 justify-between grid-cols-2'>
          ...
          <div className='w-full'>
            <div>
              <h1 className="font-mono text-neutral-700 dark:text-neutral-300 text-[18px] font-medium">Social Links</h1>
            </div>
            <div className='pl-1 py-3'>
              {
